                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="colecao_id" name="colecao_id" class="form-control" >
                                                    ...
                                                    @foreach($colecoes as $row)
                                                        <option value="{{ $row['id'] }}" @if (isset($item->colecao_id) && $row['id'] == $item->colecao_id)  selected="selected" @endif>{{ $row['nome'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="disciplina_id" name="disciplina_id" class="form-control" >
                                                    ...
                                                    @foreach($disciplinas as $row)
                                                        <option value="{{ $row['id'] }}" @if (isset($item->disciplina_id) && $row['id'] == $item->disciplina_id)  selected="selected" @endif>{{ $row['nome'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
