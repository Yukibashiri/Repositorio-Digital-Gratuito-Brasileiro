...
{{--                         <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="assets/images/users/1.jpg" alt="user-img" class="img-circle"><span class="hide-menu">Prof. Mark</span></a>
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/usuario') }}"><i class="icon-speedometer"></i><span class="hide-menu">Usuários</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/item') }}"><i class="icon-speedometer"></i><span class="hide-menu">Materiais científicos</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/categoria') }}"><i class="icon-speedometer"></i><span class="hide-menu">Cargos</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/arquivo_extensao') }}"><i class="icon-speedometer"></i><span class="hide-menu">Extensões de Arquivo</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/papel') }}"><i class="icon-speedometer"></i><span class="hide-menu">Papéis</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/situacao') }}"><i class="icon-speedometer"></i><span class="hide-menu">Situações</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/colecao') }}"><i class="icon-speedometer"></i><span class="hide-menu">Coleções</span></a>
                        </li>

                        <li> <a class="waves-effect waves-dark" href="{{ url('/dashboard/tags') }}"><i class="icon-speedometer"></i><span class="hide-menu">Tags</span></a>
                        </li>
                         
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-align-left"></i><span class="hide-menu">Instituição</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><i class="mdi-book-open-outline"></i><a href="{{ url('/dashboard/curso') }}">Cursos</a></li>

                                <li><i class="mdi mdi-book-open-outline"></i><a href="{{ url('/dashboard/disciplina') }}">Disciplinas</a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="waves-effect waves-dark" href="../documentation/documentation.html" aria-expanded="false"><i class="far fa-circle text-danger"></i><span class="hide-menu">Documentação</span></a></li>
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            @if(isset($crud))
                            <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Criar Novo</button>
                            @endif
                        </div>
                    </div>
                </div>
